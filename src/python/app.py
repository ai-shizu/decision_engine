...
VECTORS_BIN = ROOT / "data" / "processed" / "vectors.bin"
METADATA_JSON = ROOT / "data" / "processed" / "metadata.json"
PROFILE_JSON = ROOT / "data" / "processed" / "deep_profile.json"
KNOWLEDGE_DIR = ROOT / "data" / "knowledge"
SEARCH_EXE = ROOT / "build" / "search_engine.exe"
TMP_QUERY_BIN = ROOT / "data" / "processed" / "_app_query.bin"
LAST_ANSWER_MD = ROOT / "data" / "processed" / "last_consultation.md"
